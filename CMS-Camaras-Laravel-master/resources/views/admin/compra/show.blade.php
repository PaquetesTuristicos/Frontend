		...
		<div class="row">
			<div class="col">
				<ul class="list-group list-group-flush">
					...
					<li class="list-group-item">Total: <span class="float-right">$ {{ $compra->total }} </span></li>
	...
	<div class="card-group mt-1">
		@foreach( $compra->productos as $producto )
			<div class="card bg-light border-warning">
				...
				<ul class="list-group list-group-flush">
					<li class="list-group-item">Precio: <span class="float-right">$ {{ $producto->precio }} </span></li>
